...
var/global/list/spec_hair_lizard_list = list() //stores /datum/sprite_accessory/hair indexed by name
var/global/list/spec_hair_bird_list = list() //stores /datum/sprite_accessory/hair indexed by name
	//Underwear
